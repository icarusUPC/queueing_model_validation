...
class stitch_cmd_t(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(stitch_cmd_t._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != stitch_cmd_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return stitch_cmd_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        if stitch_cmd_t in parents: return 0
        tmphash = (0x998a0cc53d410405) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if stitch_cmd_t._packed_fingerprint is None:
            stitch_cmd_t._packed_fingerprint = struct.pack(">Q", stitch_cmd_t._get_hash_recursive([]))
        return stitch_cmd_t._packed_fingerprint
