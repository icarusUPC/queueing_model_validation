...
class hotspot_cmd_t(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(hotspot_cmd_t._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != hotspot_cmd_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return hotspot_cmd_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        if hotspot_cmd_t in parents: return 0
    ...
    def _get_packed_fingerprint():
        if hotspot_cmd_t._packed_fingerprint is None:
            hotspot_cmd_t._packed_fingerprint = struct.pack(">Q", hotspot_cmd_t._get_hash_recursive([]))
        return hotspot_cmd_t._packed_fingerprint
